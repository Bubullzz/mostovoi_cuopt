...
template std::unique_ptr<lp_solution_interface_t<cuopt_int_t, double>> solve_lp_remote(
  cpu_optimization_problem_t<cuopt_int_t, double> const&, pdlp_solver_settings_t<cuopt_int_t, double> const&);

template std::unique_ptr<mip_solution_interface_t<cuopt_int_t, double>> solve_mip_remote(
  cpu_optimization_problem_t<cuopt_int_t, double> const&, mip_solver_settings_t<cuopt_int_t, double> const&);
