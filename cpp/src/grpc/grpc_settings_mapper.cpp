...
template void map_pdlp_settings_to_proto(const pdlp_solver_settings_t<cuopt_int_t, float>& settings,
                                         cuopt::remote::PDLPSolverSettings* pb_settings);
template void map_proto_to_pdlp_settings(const cuopt::remote::PDLPSolverSettings& pb_settings,
                                         pdlp_solver_settings_t<cuopt_int_t, float>& settings);
template void map_mip_settings_to_proto(const mip_solver_settings_t<cuopt_int_t, float>& settings,
                                        cuopt::remote::MIPSolverSettings* pb_settings);
template void map_proto_to_mip_settings(const cuopt::remote::MIPSolverSettings& pb_settings,
                                        mip_solver_settings_t<cuopt_int_t, float>& settings);
#endif

#if CUOPT_INSTANTIATE_DOUBLE
template void map_pdlp_settings_to_proto(const pdlp_solver_settings_t<cuopt_int_t, double>& settings,
                                         cuopt::remote::PDLPSolverSettings* pb_settings);
template void map_proto_to_pdlp_settings(const cuopt::remote::PDLPSolverSettings& pb_settings,
                                         pdlp_solver_settings_t<cuopt_int_t, double>& settings);
template void map_mip_settings_to_proto(const mip_solver_settings_t<cuopt_int_t, double>& settings,
                                        cuopt::remote::MIPSolverSettings* pb_settings);
template void map_proto_to_mip_settings(const cuopt::remote::MIPSolverSettings& pb_settings,
