...
template void map_problem_to_proto(const cpu_optimization_problem_t<cuopt_int_t, float>& cpu_problem,
                                   cuopt::remote::OptimizationProblem* pb_problem);
template void map_proto_to_problem(const cuopt::remote::OptimizationProblem& pb_problem,
                                   cpu_optimization_problem_t<cuopt_int_t, float>& cpu_problem);
template size_t estimate_problem_proto_size(
  const cpu_optimization_problem_t<cuopt_int_t, float>& cpu_problem);
...
template void map_problem_to_proto(const cpu_optimization_problem_t<cuopt_int_t, double>& cpu_problem,
                                   cuopt::remote::OptimizationProblem* pb_problem);
template void map_proto_to_problem(const cuopt::remote::OptimizationProblem& pb_problem,
                                   cpu_optimization_problem_t<cuopt_int_t, double>& cpu_problem);
template size_t estimate_problem_proto_size(
  const cpu_optimization_problem_t<cuopt_int_t, double>& cpu_problem);
template void populate_chunked_header_lp(
  const cpu_optimization_problem_t<cuopt_int_t, double>& cpu_problem,
