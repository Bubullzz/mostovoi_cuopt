...
ping_pong_graph_t<i_t>::ping_pong_graph_t(rmm::cuda_stream_view stream_view, bool capture_disabled)
  : stream_view_(stream_view), capture_disabled_(capture_disabled)
{
}
