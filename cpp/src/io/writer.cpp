...
template void write_mps<cuopt_int_t, float>(const data_model_view_t<cuopt_int_t, float>& problem,
                                    const std::string& mps_file_path);
template void write_mps<cuopt_int_t, double>(const data_model_view_t<cuopt_int_t, double>& problem,
                                     const std::string& mps_file_path);
