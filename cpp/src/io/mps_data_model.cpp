...
template class CUOPT_EXPORT mps_data_model_t<index_t, double>;
...
template CUOPT_EXPORT void canonicalize_quadratic_constraints<index_t, double>(
  std::vector<mps_data_model_t<index_t, double>::quadratic_constraint_t>&);
