...
TEST(pdlp_class, precision_mixed)
{
  ...
  auto settings_mixed   = pdlp_solver_settings_t<cuopt_int_t, double>{};
  ...
  optimization_problem_solution_t<cuopt_int_t, double> solution_mixed =
  ...
  auto settings_full   = pdlp_solver_settings_t<cuopt_int_t, double>{};
  ...
  optimization_problem_solution_t<cuopt_int_t, double> solution_full =
...
TEST(pdlp_class, concurrent_pdlp_exception_joins_worker_threads)
{
  ...
  optimization_problem_solution_t<cuopt_int_t, double> solution = solve_lp(&handle_, op_problem, settings);
...
TEST(pdlp_class, batch_iteration_limit_updates_additional_termination_stats)
{
  ...
  auto solution            = solve_lp_batch_fixed<cuopt_int_t, double>(
...
TEST(pdlp_class, batch_settings_overrides_preserve_user_limits_and_tolerances)
{
  ...
  auto default_settings      = pdlp_solver_settings_t<cuopt_int_t, double>{};
  default_settings.method    = method_t::PDLP;
  default_settings.presolver = presolver_t::None;

  auto default_solution =
    solve_lp_batch_fixed<cuopt_int_t, double>(&handle_, op_problem, default_settings, batch_size);
  RAFT_CUDA_TRY(cudaDeviceSynchronize());
  ...
  auto tighter_tolerance_settings      = pdlp_solver_settings_t<cuopt_int_t, double>{};
  ...
  auto tighter_tolerance_solution =
    solve_lp_batch_fixed<cuopt_int_t, double>(&handle_, op_problem, tighter_tolerance_settings, batch_size);
  RAFT_CUDA_TRY(cudaDeviceSynchronize());
  ...
  auto iteration_limit_settings            = pdlp_solver_settings_t<cuopt_int_t, double>{};
  ...
  auto iteration_limit_solution =
    solve_lp_batch_fixed<cuopt_int_t, double>(&handle_, op_problem, iteration_limit_settings, batch_size);
  RAFT_CUDA_TRY(cudaDeviceSynchronize());
...
TEST(pdlp_class, run_time_limit)
{
  ...
  cuopt::mathematical_optimization::io::mps_data_model_t<cuopt_int_t, double> op_problem =
    cuopt::mathematical_optimization::io::read_mps<cuopt_int_t, double>(path);
...
TEST(pdlp_class, initial_solution_test)
{
  ...
  auto op_problem =
    cuopt::mathematical_optimization::mps_data_model_to_optimization_problem<cuopt_int_t, double>(
  ...
  {
    cuopt::mathematical_optimization::pdlp::pdlp_solver_t<cuopt_int_t, double> solver(problem,
                                                                              solver_settings);
...
TEST(pdlp_class, initial_primal_weight_step_size_test)
{
  ...
  // an initial primal / dual is indeed different
  {
    ...
    cuopt::mathematical_optimization::pdlp::pdlp_solver_t<cuopt_int_t, double> solver2(problem,
                                                                               solver_settings);
    ...
    cuopt::mathematical_optimization::pdlp::pdlp_solver_t<cuopt_int_t, double> solver3(problem,
                                                                               solver_settings);
    pdlp_timer = timer_t(solver_settings.time_limit);
...
End
  ...
  auto problem = cuopt::mathematical_optimization::mip::problem_t<cuopt_int_t, double>(op_problem);

  pdlp_solver_settings_t<cuopt_int_t, double> solver_settings;
...
TEST(pdlp_class, best_primal_so_far_iteration)
{
  ...
  solver_settings.method                  = cuopt::mathematical_optimization::method_t::PDLP;
  solver_settings.pdlp_solver_mode = cuopt::mathematical_optimization::pdlp_solver_mode_t::Stable2;
  cuopt::mathematical_optimization::io::mps_data_model_t<cuopt_int_t, double> op_problem1 =
    cuopt::mathematical_optimization::io::read_mps<cuopt_int_t, double>(path);
  cuopt::mathematical_optimization::io::mps_data_model_t<cuopt_int_t, double> op_problem2 =
    cuopt::mathematical_optimization::io::read_mps<cuopt_int_t, double>(path);

  optimization_problem_solution_t<cuopt_int_t, double> solution1 =
    solve_lp(&handle1, op_problem1, solver_settings);
  RAFT_CUDA_TRY(cudaDeviceSynchronize());
  solver_settings.save_best_primal_so_far = true;
  optimization_problem_solution_t<cuopt_int_t, double> solution2 =
...
TEST(pdlp_class, batch_per_constraint_residual_stable3)
{
  ...
  auto batch_sol                   = solve_lp<cuopt_int_t, double>(&handle, op_problem, solver_settings);
  RAFT_CUDA_TRY(cudaDeviceSynchronize());
...
TEST(pdlp_class, batch_per_constraint_residual_different_rhs_stable3)
{
  ...
  auto batch_sol = solve_lp_batch_fixed<cuopt_int_t, double>(
  ...
  auto climber0_problem = cuopt::mathematical_optimization::io::read_mps<cuopt_int_t, double>(path);
  auto climber1_problem = cuopt::mathematical_optimization::io::read_mps<cuopt_int_t, double>(path);
...
TEST(pdlp_class, warm_start)
{
  ...
  for (auto instance_name : instance_names) {
    ...
    optimization_problem_solution_t<cuopt_int_t, double> solution1 = solve_lp(op_problem1, solver_settings);
    ...
    auto op_problem2 =
      cuopt::mathematical_optimization::mps_data_model_to_optimization_problem<cuopt_int_t, double>(
        &handle, mps_data_model);
    optimization_problem_solution_t<cuopt_int_t, double> solution2 = solve_lp(op_problem2, solver_settings);
    ...
    optimization_problem_solution_t<cuopt_int_t, double> solution3 = solve_lp(op_problem3, solver_settings);
...
TEST(pdlp_class, warm_start_stable3_not_supported)
{
  ...
  auto op_problem =
    cuopt::mathematical_optimization::mps_data_model_to_optimization_problem<cuopt_int_t, double>(
      &handle, mps_data_model);
  optimization_problem_solution_t<cuopt_int_t, double> solution = solve_lp(op_problem, solver_settings);
  ...
  optimization_problem_solution_t<cuopt_int_t, double> solution2 = solve_lp(op_problem, solver_settings);
...
TEST(pdlp_class, more_complex_batch_different_bounds)
{
  ...
  optimization_problem_solution_t<cuopt_int_t, double> solution3 =
    solve_lp(&handle_, op_problem, solver_settings);
...
TEST(pdlp_class, run_batch_pdlp_fixed_rejects_partial_per_climber_expansion)
{
  ...
  auto make_settings = []() {
    pdlp_solver_settings_t<cuopt_int_t, double> s{};
...
TEST(pdlp_class, run_batch_pdlp_rejects_invalid_new_bounds)
{
  ...
  auto expect_validation_error = [&](pdlp_solver_settings_t<cuopt_int_t, double> settings) {
    auto gpu_op =
      cuopt::mathematical_optimization::mps_data_model_to_optimization_problem<cuopt_int_t, double>(
        &handle_, op_problem);
    try {
...
TEST(pdlp_class, run_batch_pdlp_many_different_bounds)
{
  ...
  auto regular_pdlp_settings             = pdlp_solver_settings_t<cuopt_int_t, double>{};
  ...
  optimization_problem_solution_t<cuopt_int_t, double> batch_solution =
...
TEST(pdlp_class, many_different_bounds)
{
  ...
  optimization_problem_solution_t<cuopt_int_t, double> batch_sol =
    solve_lp(&handle_, op_problem, solver_settings);
...
TEST(pdlp_class, shared_sb_context_unit)
{
  ...
  constexpr int N = 10;
  shared_strong_branching_context_t<cuopt_int_t, double> ctx(N);
  shared_strong_branching_context_view_t<cuopt_int_t, double> view(ctx.solved);

  EXPECT_TRUE(view.is_valid());

  shared_strong_branching_context_view_t<cuopt_int_t, double> empty_view;
...
TEST(pdlp_class, shared_sb_view_batch_pre_solved)
{
  ...
  shared_strong_branching_context_t<cuopt_int_t, double> shared_ctx(batch_size);
  shared_strong_branching_context_view_t<cuopt_int_t, double> sb_view(shared_ctx.solved);
...
TEST(pdlp_class, shared_sb_view_concurrent_mark)
{
  ...
  optimization_problem_solution_t<cuopt_int_t, double>* result_ptr = nullptr;

  auto pdlp_thread = std::thread([&]() {
    auto sol = new optimization_problem_solution_t<cuopt_int_t, double>(
      solve_lp(&handle_, op_problem, solver_settings));
    result_ptr = sol;
  });
  ...
  for (int i = 0; i < batch_size; ++i) {
    ...
    EXPECT_TRUE(status == pdlp_termination_status_t::Optimal ||
      ...
      << cuopt::mathematical_optimization::optimization_problem_solution_t<cuopt_int_t, double>::
...
TEST(pdlp_class, batch_bound_objective_rescaling_factors_match_input_expansion)
{
  ...
  auto compute_rescaling = [&](std::vector<double> const& objectives,
    ...
    cuopt::mathematical_optimization::mip::problem_t<cuopt_int_t, double> problem(gpu_op);
    cuopt::mathematical_optimization::pdlp::pdlp_initial_scaling_strategy_t<cuopt_int_t, double> scaling(
      &handle_,
      problem,
